    ...
    <div className="bg-gray-200 font-sans h-screen w-full flex flex-row justify-center items-center">
      {
        ...
        <FontAwesomeIcon icon={faUser} size="xs"/> {user?.name}
        </div>
